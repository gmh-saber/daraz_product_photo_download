...
<head>
    ...
    <!-- Chosen Palette: "Calm Neutrals" - A palette of off-white, slate gray, and a soft blue accent to create a calm, professional, and focused reading environment. -->
    <!-- Application Structure Plan: The application uses a tabbed interface to segment the README content into logical sections: "Overview," "Usage Guide," and "The Code." This structure was chosen over a linear document to improve navigability and allow users to quickly access the information most relevant to them (e.g., jumping straight to the code). The interactive tabs are controlled by JavaScript, providing a smooth single-page application experience. This design choice makes the technical information more digestible and less overwhelming. -->
    <!-- Visualization & Content Choices: 
        - Report Info: README introduction and "How it Works." -> Goal: Inform -> Viz/Presentation: "Overview" tab with styled text and lists. -> Interaction: N/A. -> Justification: Clearly separates the "what" and "why" from the "how-to." -> Library/Method: HTML/Tailwind.
        - Report Info: "How to Use" and "Important Note on Downloads." -> Goal: Instruct -> Viz/Presentation: "Usage Guide" tab with ordered lists and a highlighted alert box for the note. -> Interaction: N/A. -> Justification: Consolidates all instructional content. -> Library/Method: HTML/Tailwind.
        - Report Info: The JavaScript code snippet. -> Goal: Provide Tool -> Viz/Presentation: "The Code" tab with a formatted code block. -> Interaction: A one-click "Copy Code" button. -> Justification: The primary purpose of the document is to provide this code; this makes it easily accessible and usable. -> Library/Method: HTML/Tailwind/JS for copy functionality.
        - CONFIRMATION: NO SVG graphics used. NO Mermaid JS used. -->
    <style>
        body { font-family: 'Inter', sans-serif; }
        .tab-active { 
            background-color: #ffffff;
            color: #1e3a8a; /* A darker blue for active text */
        ...
        .code-block {
            background-color: #1f2937; /* Dark gray for code block */
...
<body class="bg-gray-50 text-gray-800">
    ...
    <div class="container mx-auto p-4 sm:p-6 md:p-8 max-w-4xl">
        ...
        <header class="text-center mb-8">
            <h1 class="text-3xl sm:text-4xl font-bold text-gray-900">Image Link Extractor Script</h1>
            <p class="mt-2 text-lg text-gray-600">An Interactive Guide to the Browser Console Tool</p>
        </header>
        ...
        <main class="bg-white rounded-lg shadow-md p-6 sm:p-8">
            ...
            <div id="tab-content-container">
                <section id="overview" class="tab-content space-y-6">
                    <p class="text-gray-700">This JavaScript snippet is designed to be run directly in your web browser's developer console. It automates the process of extracting image source (`src`) links from a webpage, cleaning them, and copying the cleaned links to your clipboard.</p>
                ...
                <section id="usage" class="tab-content space-y-6">
                    ...
                    <ol class="list-decimal list-inside space-y-4 text-gray-700">
                        ...
                        <li>
                            <strong>Copy & Paste the Code:</strong> Copy the code from "The Code" tab and paste it into the console's input area.
                        </li>
                        <li>
                ...
                <section id="code" class="tab-content">
                    <div class="code-block">
                        <button id="copy-btn" class="copy-button">Copy Code</button>
                        <pre><code id="code-snippet" class="language-javascript">
// This script targets image elements on the currently loaded webpage.
...
if (cleanedSrcLinks.length > 0) {
    ...
    console.log("No matching image links found on this page.");
}
                        </code></pre>
                    </div>
                </section>
